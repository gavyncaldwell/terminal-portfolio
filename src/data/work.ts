...
export const workExperience: WorkExperience[] = [
  {
    ...
    period: "2023 - Present",
    description: "Building enterprise advertising analytics dashboards and leading significant modernization efforts.",
    highlights: [
  ...
  },
  {
    ...
    role: "Senior Frontend Developer",
    period: "2022 - 2023",
    description: "Drove success in consumer-facing and white-label applications using Next.js and React.",
    highlights: [
  ...
  },
  {
    ...
    period: "2018 - 2022",
    description: "Led a distributed frontend team of 5 developers building multiple e-commerce products.",
    highlights: [
...
export const projects: Project[] = [
  {
    ...
    description: "This portfolio site you're looking at — terminal aesthetic with React and TypeScript",
